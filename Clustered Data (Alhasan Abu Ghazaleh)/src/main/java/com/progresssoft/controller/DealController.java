...
public class DealController {
	...
	public @ResponseBody ResponseStatus addDeal(DealDetailWrapper request) {

		ResponseStatus responseStatus = dealService.saveDealData(request);
		return responseStatus;
	}

	@RequestMapping(value = "/addCurrency", method = RequestMethod.POST)
	public @ResponseBody ResponseStatus addCurrency(String currencyName) {

		ResponseStatus responseStatus = currencyService.addCurrency(currencyName);
		return responseStatus;
	}
